...
% ========================================================================================
    ...
    methods (Static = true, Access = 'public')
        ...
        function [outletProfile, simMex, lastState] = secColumn(inletProfile, params, simMex, lastState, num, ParSwarm)
% ----------------------------------------------------------------------------------------
...
% ----------------------------------------------------------------------------------------
        ...
        function [outletProfile, lastState, currentData] = colSolver(currentData, interstVelocity, Feed, Desorbent, opt, sequence, k, j, simMex, varargin)
% ----------------------------------------------------------------------------------------
...
% ----------------------------------------------------------------------------------------
            ...
            if opt.enable_CSTR
                ...
                [outletProfile, simMex, lastState] = SMB.secColumn(column.inlet, column.params, simMex, column.initialState, sequence.(k), varargin{:});
        ...
        function [currentData, tempData, transitionData, sequence, convergIndx, ...
                convergPrevious, dummyProfile, dyncData, plotData] = preallocation(Feed, opt)
% ----------------------------------------------------------------------------------------
...
% ----------------------------------------------------------------------------------------
        ...
        function dyncData = dyncDataUpdate(dyncData, currentData, sequence, stringSet, opt, i, j)
% ----------------------------------------------------------------------------------------
...
% ----------------------------------------------------------------------------------------
        ...
        function [convergPrevious, flag] = stoppingCriterion(convergPrevious, transitionData, convergIndx, opt, i, j)
% ----------------------------------------------------------------------------------------
...
%----------------------------------------------------------------------------------------
            ...
            [outletProfile, ~, lastState] = SMB.secColumn(dummyProfile, params{idx_i}, cell(1,opt.nColumn), initialState, 1);
