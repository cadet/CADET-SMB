...
plot "trajectory.dat" using 1 with lines ls 2 lw 3 title '$c_{\text{out},1}(t)$',\
     "trajectory.dat" using 2 with lines ls 5 lw 3 title '$c_{\text{out},2}(t)$'
...
plot "trajectory.dat" using 3 with lines ls 2 lw 3 title '$c_{\text{out},1}(t)$',\
     "trajectory.dat" using 4 with lines ls 5 lw 3 title '$c_{\text{out},2}(t)$'
