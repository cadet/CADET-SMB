...
set ytics 0.001
set xtics 10000
set xtics add ("0" 0, "10" 10000, "20" 20000, "30" 30000, "40" 40000, "50" 50000)
...
plot "1_trajectory.dat" using 1 with lines ls 2 lw 3 title '$c_{\text{out},1}(t)$', \
     "1_trajectory.dat" using 2 with lines ls 5 lw 3 title '$c_{\text{out},2}(t)$', \
     "1_trajectory.dat" using 3 with lines ls 7 lw 3 title '$c_{\text{out},3}(t)$'
...
plot "1_trajectory.dat" using 4 with lines ls 2 lw 3 title '$c_{\text{out},1}(t)$', \
     "1_trajectory.dat" using 5 with lines ls 5 lw 3 title '$c_{\text{out},2}(t)$', \
     "1_trajectory.dat" using 6 with lines ls 7 lw 3 title '$c_{\text{out},3}(t)$'
