...
plot "chromatogram.dat" using 1 with lines ls 2 lw 3.5 title '$c_1(\tau, z)$', \
     ...
     "chromatogram.dat" using 3 with lines ls 7 lw 3.5 title '$c_3(\tau, z)$'


unset ylabel
plot "chromatogram.dat" using 4 with lines ls 2 lw 3.5 title '$c_1(\tau, z)$', \
     "chromatogram.dat" using 5 with lines ls 5 lw 3.5 title '$c_2(\tau, z)$'
