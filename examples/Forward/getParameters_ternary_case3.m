...
% =============================================================================
%   Case 3, a 5-zone ten-column case for ternary separation (two raffinate)
%
...
% =============================================================================
    ...
    opt.nInterval       = 20;
    opt.switch          = 1080/opt.nInterval;   % s  % switching time
    opt.timePoints      = 1000/opt.nInterval;  % the observed time-points
    opt.Purity_limit    = [0.99, 0.38, 0.94];  % used for constructing constraints
    ...
    opt.nColumn     = 10;
    opt.structID    = [2 2 2 2 2];
    opt.intermediate = 'raffinate'; % two extract configuration
    ...
    % Transport
    opt.dispersionColumn          = ones(1, opt.nZone) .* 1.1781e-7; % D_{ax}
    ...
    flowRate.recycle    = 7.54e-6/60;      % m^3/s
    flowRate.feed       = 2.11e-6/60;      % m^3/s
    flowRate.raffinate1 = 2.41e-6/60;      % m^3/s
    flowRate.raffinate2 = 1.00e-6/60;      % m^3/s
    flowRate.desorbent  = 4.16e-6/60;      % m^3/s
    flowRate.extract    = 2.86e-6/60;      % m^3/s
    opt.flowRate_extract  = flowRate.extract;
    opt.flowRate_raffinate1 = flowRate.raffinate1;
