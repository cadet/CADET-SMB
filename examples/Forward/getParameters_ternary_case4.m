...
% =============================================================================
    ...
    opt.nInterval       = 20;
    opt.switch          = 1552/opt.nInterval; % s
    ...
    opt.nZone       = 8;
    opt.nColumn     = 8;
    opt.structID    = [1 1 1 1 1 1 1 1]; % 8 columns in eight-zone, 1 in each zone
    opt.intermediate_feed = 'raffinate'; % the feed 2 stream is the raffinate port of first subunit
    ...
    % Transport
    opt.dispersionColumn          = ones(1, opt.nZone) .* 3.8148e-16;   % D_{ax} m^2/s
    ...
    opt.molMass         = [180.16, 180.16, 180.16]; % g/mol
